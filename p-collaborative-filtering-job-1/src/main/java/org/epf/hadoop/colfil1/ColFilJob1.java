...
public class ColFilJob1 {
    public static void main(String[] args) throws Exception {
        ...
        // Configurer les types de sortie intermédiaire
        job.setMapOutputKeyClass(Text.class);
        job.setMapOutputValueClass(Text.class);

        // Configurer les types de sortie finale
        job.setOutputKeyClass(Text.class);
        job.setOutputValueClass(Text.class);

        // Configurer le nombre de reducers
        job.setNumReduceTasks(1); // Pour n'avoir qu'un seul fichier de sortie part-r-00000
